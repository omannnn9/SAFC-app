      ...
      >
        <div className="relative overflow-hidden rounded-[22px] bg-[#0b0b0b] p-5 text-white">
          ...
          <div
            ...
            style={{ background: tone.grad, opacity: 0.25, filter: "blur(36px)" }}
          />
          ...
          <div className="relative flex items-start justify-between">
            ...
            <span
              className={`rounded-full px-2.5 py-1 text-[10px] font-black uppercase tracking-wider ${tone.bg} ${tone.text} ring-1 ${tone.ring}/50`}
            >
              {def.badge}
            </span>
          </div>
          ...
          <div className="relative mt-5 grid grid-cols-3 gap-3 border-t border-white/10 pt-4 text-[10px]">
            <div>
              ...
              <div
                className={`mt-0.5 font-display text-sm font-black ${isFounderCard ? "text-[var(--safc-yellow)]" : "text-white"}`}
              >
            ...
            <div>
              ...
              <div className="mt-0.5 font-display text-sm font-black">
                {def.name.split(" — ")[0]}
              </div>
            </div>
            <div>
