  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative flex items-center gap-2 rounded-full bg-[color:var(--sa-gold)] px-3.5 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-black shadow-[0_10px_30px_-8px_rgba(255,215,0,0.6)] animate-[bounce_1.8s_ease-in-out_infinite]">
