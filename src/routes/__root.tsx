  ...
  head: () => ({
    meta: [
      ...
      { title: "SA FC — South Africa Football Community" },
      {
        name: "description",
        content:
          "SA FC — South Africa Football Community. The supporter platform for matchday energy, events, and culture. Join the community.",
      },
      { name: "author", content: "SA FC" },
      { property: "og:title", content: "SA FC — South Africa Football Community" },
      ...
      { name: "twitter:title", content: "SA FC — South Africa Football Community" },
...
const HIDE_NAV = ["/login", "/signup", "/auth/callback", "/privacy", "/terms"];
