...
import { jsonResponse, WATCH_PARTY_SOURCES, type WatchPartySignupMetadata } from "@/lib/watchparty";
  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        // Keep detailed signup lists and winner actions protected by the admin token.
