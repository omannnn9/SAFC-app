  ...
  if (!headers.has("Content-Security-Policy")) {
    headers.set(
      ...
      [
        ...
        "img-src 'self' data: blob: https://*.supabase.co https://auth.southafricafc.com https://34.35.110.246.sslip.io https://lh3.googleusercontent.com https://*.googleusercontent.com",
        "font-src 'self' data: https://fonts.gstatic.com",
        "connect-src 'self' https://*.supabase.co https://auth.southafricafc.com wss://*.supabase.co wss://auth.southafricafc.com https://api.stripe.com https://accounts.google.com",
